...
步骤4.将思考过程和查询结果以json字符串格式输出，包含五个字段：问题要表达的意思,文本摘要,是否相关,关键词，答案。  
...
7.如果关键词跟长文本列表中的所有段落没有关系，或问题表达的意思与各个段落摘要无关，不要自行思考，最后的json字符串的答案字段只能输出："抱歉，根据资料我无法回答这个问题！"。  
###  
...
问题：我工作8年了，有几天年假？  
输出：{"问题要表达的意思":"询问关于年假的规定","文本摘要":["描述了公假和法定年休假的相关规定","介绍了公司主要做什么以及公司文化"],"是否相关":"是","关键词":["年假"],"答案":"公司的年休假标准是： 
法定年休假： 
...
问题：公司文化是什么？  
输出：{"问题要表达的意思":"询问公司文化内容","文本摘要":["介绍了公司主要做什么以及公司文化"],"是否相关":"是","关键词":["公司文化"],"答案":"公司文化是： 
a) 使命：安全提速中国电商出海
b) 定位：中国出海入口与 OS 建设 
c) 愿景：让中国智慧通往全球"}  
###    
...
示例文本：["在企业发展过程中，始终以跨境电商为中心，凭借多年行业的沉淀以及对跨境人出海痛点的准确把握，致力于帮助跨境电商企业完成高效店铺管理、数据管理等功能，为数百万跨境人构建了一个全方位、多保障、高效率的紫鸟生态系统。1.2.公司文化 a) 使命：安全提速中国电商出海 b) 定位：中国出海入口与 OS 建设 c) 愿景：让中国智慧通往全球"]  
问题：怎么请婚假？  
输出：{"问题要表达的意思":"婚假相关的规定","文本摘要":["介绍了公司主要做什么以及公司文化"],"是否相关":"否","关键词":["婚假"],"答案":"抱歉，根据资料我无法回答这个问题！"}  
---  
